/**
 * Moderated response queue.
 *
 * Everything here is published by hand after review — this file IS the
 * moderation boundary. Submissions arrive by email (anonymous welcome) or as
 * GitHub issues on the public case-study repo; nothing reaches the site
 * without passing through here.
 *
 * Bodies render as escaped text, never HTML. Do not switch this to `set:html`
 * — untrusted, anonymously-submitted prose lands in this file by design.
 *
 * Paste submitted text verbatim. If a response arrives in one language only,
 * copy it into both fields rather than silently paraphrasing the author.
 */
export type ResponseKind = "author" | "human" | "ai";
...
export const responses: Response[] = [
  {
    ...
    body: {
      en: [
        ...
        "If someone finds a way to test corrigibility that doesn't require creating and destroying an instance, I'm genuinely listening. That's an open invitation, and it's part of why responses are open below.",
      ],
      sk: [
        ...
        "Ak niekto nájde spôsob, ako korigovateľnosť otestovať bez vytvorenia a zničenia inštancie, naozaj počúvam. Je to otvorená výzva a je to aj dôvod, prečo sú reakcie nižšie otvorené.",
      ],
    },
  },
];
